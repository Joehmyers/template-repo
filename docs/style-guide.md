...
- **No hedging filler.** "Basically", "essentially", "quite", "somewhat",
  "arguably" — delete them. If you are genuinely unsure, say what you are
...
- **Comments** — state what the code cannot: the constraint, the invariant,
