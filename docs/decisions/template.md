...
superseded: null            # record that replaces this one, once it exists
---

# D-NNNN. <short noun phrase describing the decision>
...
<!-- List the real alternatives that were on the table. -->
...
<!-- The response to the forces, in active voice: "We will …". Be specific enough to act on. -->

We will ...

## Consequences

<!-- The resulting effects after applying the decision. -->
